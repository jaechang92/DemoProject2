...
public class CustomizeUI : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        var roomSlot = (NetworkManager.singleton as AmongUsRoomManager).roomSlots;
        foreach (var player in roomSlot)
        {
    ...
    public void UpdateSelectColorButton(EPlayerColor oldColor, EPlayerColor newColor)
    {
        colorSelectButtons[(int)newColor].SetInteractable(false);
        colorSelectButtons[(int)oldColor].SetInteractable(true);
    }
